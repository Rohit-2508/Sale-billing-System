    ...
    <_defaultLayout>
     ...
     setPopModal(false)
      ...
      Customer Name : <b>{selectedBill.customerName}</b>
       <br/> 
       Phone No: <b>{selectedBill.cutomerContact}</b> 
       <br/>
      Date: <b>{selectedBill.date.toString().substring(0, 10)}
      </b>
       <br />
         </p>
   <hr style={{ margin: "5px" }} />
...
<td />
<td className="Rate">
<h2>Grand Total</h2> </td>
<td className="payment"> <h2>
